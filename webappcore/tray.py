"""
pystray-based system tray for WebAppCore Desktop.
...
class TrayController:
    ...
    def _run(self):
        icon_path = get_app_icon_path(settings_manager.get("WEBAPPCORE_ICON_PATH"))
        try:
        ...
        items = [
            pystray.MenuItem("WebAppCore", self._show_main, default=True),
        ...
        self._icon = pystray.Icon("webappcore", image, "WebAppCore", menu)
        self._icon.run()
